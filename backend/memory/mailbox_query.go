...
func (mq *MailboxQuery) FirstID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (mq *MailboxQuery) FirstIDX(ctx context.Context) uuid.UUID {
...
func (mq *MailboxQuery) OnlyID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (mq *MailboxQuery) OnlyIDX(ctx context.Context) uuid.UUID {
...
func (mq *MailboxQuery) IDs(ctx context.Context) (ids []uuid.UUID, err error) {
...
func (mq *MailboxQuery) IDsX(ctx context.Context) []uuid.UUID {
	ids, err := mq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (mq *MailboxQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(mailbox.Table, mailbox.Columns, sqlgraph.NewFieldSpec(mailbox.FieldID, field.TypeUUID))
	_spec.From = mq.sql
